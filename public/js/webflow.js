...
Webflow.require('ix').init([
  {"slug":"open-modal","name":"Open Modal","value":{"style":{},"triggers":[{"type":"click","selector":".bank-modal","stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 400ms ease 0"}],"stepsB":[]}]}},
  {"slug":"modal-opacity","name":"Modal Opacity","value":{"style":{"display":"none","opacity":0},"triggers":[]}},
  {"slug":"close-modal","name":"Close Modal","value":{"style":{},"triggers":[{"type":"click","selector":".bank-modal","stepsA":[{"opacity":0,"transition":"opacity 200 ease 0"},{"display":"none"}],"stepsB":[]}]}}
]);
